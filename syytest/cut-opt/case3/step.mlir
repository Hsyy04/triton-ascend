  ...
  func.func @_swa_fwd_kernel(%arg0: memref<?xi8>, %arg1: memref<?xi8>, %arg2: memref<?xbf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg3: memref<?xf32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg4: memref<?xf32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg5: memref<?xbf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg6: memref<?xbf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg7: memref<?xbf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg8: i32, %arg9: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg10: memref<?xi32> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg11: f32, %arg12: i32 {tt.divisibility = 16 : i32}, %arg13: i32 {tt.divisibility = 16 : i32}, %arg14: i32 {tt.divisibility = 16 : i32}, %arg15: i32 {tt.divisibility = 16 : i32}, %arg16: i32, %arg17: i32 {tt.divisibility = 16 : i32}, %arg18: i32 {tt.divisibility = 16 : i32}, %arg19: i32 {tt.divisibility = 16 : i32}, %arg20: i32 {tt.divisibility = 16 : i32}, %arg21: i32 {tt.divisibility = 16 : i32}, %arg22: i32 {tt.divisibility = 16 : i32}, %arg23: memref<?xi8> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg24: i32 {tt.divisibility = 16 : i32}, %arg25: i32 {tt.divisibility = 16 : i32}, %arg26: i32, %arg27: i32, %arg28: i32, %arg29: i32, %arg30: i32, %arg31: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "mix", parallel_mode = "simd"} {
    ...
    %15 = scf.for %arg32 = %c0_i32 to %arg8 step %c1_i32 iter_args(%arg33 = %c0_i32_7) -> (i32)  : i32 {
      ...
      scf.for %arg34 = %41 to %39 step %arg26  : i32 {
        ...
        %alloc = memref.alloc() {ssbuffer.block_id = 16 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16>
        ...
        %subview_19 = memref.subview %alloc[%74, %76] [%75, %77] [1, 1] {ssbuffer.block_id = 16 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
        ...
        scf.if %80 {
          linalg.fill {ssbuffer.block_id = 1 : i32, ssbuffer.core_type = "CUBE"} ins(%cst_5 : bf16) outs(%alloc : memref<128x128xbf16>)
        ...
        %113:3 = scf.for %arg35 = %c0_i32 to %108 step %c1_i32 iter_args(%arg36 = %8, %arg37 = %5, %arg38 = %7) -> (tensor<128xf32>, tensor<128xf32>, tensor<128x128xf32>)  : i32 {
          ...
          %alloc_30 = memref.alloc() {ssbuffer.block_id = 8 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16>
          ...
          %alloc_31 = memref.alloc() {ssbuffer.block_id = 8 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16>
          ...
          scf.if %213 {
            linalg.fill {ssbuffer.block_id = 3 : i32, ssbuffer.core_type = "CUBE"} ins(%cst_5 : bf16) outs(%alloc_31 : memref<128x128xbf16>)
          } {hivm.unlikely_condition}
          scf.if %198 {
            linalg.fill {ssbuffer.block_id = 2 : i32, ssbuffer.core_type = "CUBE"} ins(%cst_5 : bf16) outs(%alloc_30 : memref<128x128xbf16>)
          } {hivm.unlikely_condition}
          %214 = arith.addi %177, %83 {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE"} : index
          %reinterpret_cast_32 = memref.reinterpret_cast %arg6 to offset: [%214], sizes: [128, 128], strides: [%176, 1] {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE"} : memref<?xbf16> to memref<128x128xbf16, strided<[?, 1], offset: ?>>
          %subview_33 = memref.subview %reinterpret_cast_32[0, 0] [%193, %195] [1, 1] {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[?, 1], offset: ?>>
          %subview_34 = memref.subview %alloc_30[%192, %194] [%193, %195] [1, 1] {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          memref.copy %subview_33, %subview_34 {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "CUBE"} : memref<?x?xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          ...
          %reinterpret_cast_35 = memref.reinterpret_cast %arg23 to offset: [%225], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_36 = memref.alloc() {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_35, %alloc_36 {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %226 = bufferization.to_tensor %alloc_36 restrict writable {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %reinterpret_cast_37 = memref.reinterpret_cast %arg23 to offset: [%231], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_38 = memref.alloc() {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_37, %alloc_38 {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %232 = bufferization.to_tensor %alloc_38 restrict writable {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %reinterpret_cast_39 = memref.reinterpret_cast %arg23 to offset: [%238], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_40 = memref.alloc() {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_39, %alloc_40 {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %239 = bufferization.to_tensor %alloc_40 restrict writable {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %reinterpret_cast_41 = memref.reinterpret_cast %arg23 to offset: [%246], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_42 = memref.alloc() {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_41, %alloc_42 {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %247 = bufferization.to_tensor %alloc_42 restrict writable {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %251 = arith.cmpi ne, %250, %12 {ssbuffer.block_id = 20 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xi8>
          %252 = arith.mulf %217, %10 {ssbuffer.block_id = 21 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          %253 = arith.select %251, %252, %9 {ssbuffer.block_id = 21 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xi1>, tensor<128x128xf32>
          ...
          %broadcasted_43 = linalg.broadcast ins(%254 : tensor<128xf32>) outs(%6 : tensor<128x128xf32>) dimensions = [1]  {ssbuffer.block_id = 21 : i32, ssbuffer.core_type = "VECTOR"}
          %255 = arith.subf %253, %broadcasted_43 {ssbuffer.block_id = 21 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          ...
          %258 = arith.addi %180, %86 {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : index
          %reinterpret_cast_44 = memref.reinterpret_cast %arg7 to offset: [%258], sizes: [128, 128], strides: [%179, 1] {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : memref<?xbf16> to memref<128x128xbf16, strided<[?, 1], offset: ?>>
          %subview_45 = memref.subview %reinterpret_cast_44[0, 0] [%208, %210] [1, 1] {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[?, 1], offset: ?>>
          %subview_46 = memref.subview %alloc_31[%207, %209] [%208, %210] [1, 1] {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          memref.copy %subview_45, %subview_46 {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : memref<?x?xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          %259 = bufferization.to_tensor %alloc_31 restrict writable {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to tensor<128x128xbf16>
          %260 = tensor.empty() {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} : tensor<128x128xf32>
          %261 = linalg.fill {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE"} ins(%cst : f32) outs(%260 : tensor<128x128xf32>) -> tensor<128x128xf32>
          %262 = linalg.matmul {input_precision = "ieee", ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "CUBE", ssbuffer.loop_carried_l0c} ins(%257, %259 : tensor<128x128xbf16>, tensor<128x128xbf16>) outs(%261 : tensor<128x128xf32>) -> tensor<128x128xf32>
          %reduced_47 = linalg.reduce ins(%256 : tensor<128x128xf32>) outs(%5 : tensor<128xf32>) dimensions = [1]  {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"}
            (%in: f32, %init: f32) {
              %269 = arith.addf %in, %init : f32
              linalg.yield %269 : f32
            }
          %263 = arith.subf %arg36, %254 {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %264 = math.exp %263 {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %265 = arith.mulf %arg37, %264 {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %266 = arith.addf %265, %reduced_47 {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %broadcasted_48 = linalg.broadcast ins(%264 : tensor<128xf32>) outs(%6 : tensor<128x128xf32>) dimensions = [1]  {ssbuffer.block_id = 22 : i32, ssbuffer.core_type = "VECTOR"}
          %267 = arith.mulf %arg38, %broadcasted_48 {ssbuffer.block_id = 23 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          %268 = arith.addf %262, %267 {ssbuffer.add_from_matmul, ssbuffer.block_id = 23 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          scf.yield {ssbuffer.core_type = "VECTOR, VECTOR, VECTOR"} %254, %266, %268 : tensor<128xf32>, tensor<128xf32>, tensor<128x128xf32>
        ...
        %114:3 = scf.for %arg35 = %112 to %107 step %c1_i32 iter_args(%arg36 = %113#0, %arg37 = %113#1, %arg38 = %113#2) -> (tensor<128xf32>, tensor<128xf32>, tensor<128x128xf32>)  : i32 {
          ...
          %alloc_30 = memref.alloc() {ssbuffer.block_id = 15 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16>
          ...
          %alloc_31 = memref.alloc() {ssbuffer.block_id = 15 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16>
          ...
          scf.if %213 {
            linalg.fill {ssbuffer.block_id = 10 : i32, ssbuffer.core_type = "CUBE"} ins(%cst_5 : bf16) outs(%alloc_31 : memref<128x128xbf16>)
          } {hivm.unlikely_condition}
          scf.if %198 {
            linalg.fill {ssbuffer.block_id = 9 : i32, ssbuffer.core_type = "CUBE"} ins(%cst_5 : bf16) outs(%alloc_30 : memref<128x128xbf16>)
          } {hivm.unlikely_condition}
          %214 = arith.addi %177, %83 {ssbuffer.block_id = 12 : i32, ssbuffer.core_type = "CUBE"} : index
          %reinterpret_cast_32 = memref.reinterpret_cast %arg6 to offset: [%214], sizes: [128, 128], strides: [%176, 1] {ssbuffer.block_id = 12 : i32, ssbuffer.core_type = "CUBE"} : memref<?xbf16> to memref<128x128xbf16, strided<[?, 1], offset: ?>>
          %subview_33 = memref.subview %reinterpret_cast_32[0, 0] [%193, %195] [1, 1] {ssbuffer.block_id = 12 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[?, 1], offset: ?>>
          %subview_34 = memref.subview %alloc_30[%192, %194] [%193, %195] [1, 1] {ssbuffer.block_id = 12 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          memref.copy %subview_33, %subview_34 {ssbuffer.block_id = 12 : i32, ssbuffer.core_type = "CUBE"} : memref<?x?xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          ...
          %reinterpret_cast_35 = memref.reinterpret_cast %arg23 to offset: [%225], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_36 = memref.alloc() {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_35, %alloc_36 {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %226 = bufferization.to_tensor %alloc_36 restrict writable {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %reinterpret_cast_37 = memref.reinterpret_cast %arg23 to offset: [%232], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_38 = memref.alloc() {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_37, %alloc_38 {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %233 = bufferization.to_tensor %alloc_38 restrict writable {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %reinterpret_cast_39 = memref.reinterpret_cast %arg23 to offset: [%239], sizes: [128, 128], strides: [%97, 1] {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<?xi8> to memref<128x128xi8, strided<[?, 1], offset: ?>>
          %alloc_40 = memref.alloc() {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x128xi8>
          memref.copy %reinterpret_cast_39, %alloc_40 {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8, strided<[?, 1], offset: ?>> to memref<128x128xi8>
          %240 = bufferization.to_tensor %alloc_40 restrict writable {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR", was_bool_to_int8 = true} : memref<128x128xi8> to tensor<128x128xi8>
          ...
          %244 = arith.cmpi ne, %243, %12 {ssbuffer.block_id = 24 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xi8>
          %245 = arith.mulf %217, %10 {ssbuffer.block_id = 25 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          %246 = arith.select %244, %245, %9 {ssbuffer.block_id = 25 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xi1>, tensor<128x128xf32>
          ...
          %broadcasted_41 = linalg.broadcast ins(%247 : tensor<128xf32>) outs(%6 : tensor<128x128xf32>) dimensions = [1]  {ssbuffer.block_id = 25 : i32, ssbuffer.core_type = "VECTOR"}
          %248 = arith.subf %246, %broadcasted_41 {ssbuffer.block_id = 25 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          ...
          %251 = arith.addi %180, %86 {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : index
          %reinterpret_cast_42 = memref.reinterpret_cast %arg7 to offset: [%251], sizes: [128, 128], strides: [%179, 1] {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : memref<?xbf16> to memref<128x128xbf16, strided<[?, 1], offset: ?>>
          %subview_43 = memref.subview %reinterpret_cast_42[0, 0] [%208, %210] [1, 1] {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[?, 1], offset: ?>>
          %subview_44 = memref.subview %alloc_31[%207, %209] [%208, %210] [1, 1] {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          memref.copy %subview_43, %subview_44 {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : memref<?x?xbf16, strided<[?, 1], offset: ?>> to memref<?x?xbf16, strided<[128, 1], offset: ?>>
          %252 = bufferization.to_tensor %alloc_31 restrict writable {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : memref<128x128xbf16> to tensor<128x128xbf16>
          %253 = tensor.empty() {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} : tensor<128x128xf32>
          %254 = linalg.fill {ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE"} ins(%cst : f32) outs(%253 : tensor<128x128xf32>) -> tensor<128x128xf32>
          %255 = linalg.matmul {input_precision = "ieee", ssbuffer.block_id = 14 : i32, ssbuffer.core_type = "CUBE", ssbuffer.loop_carried_l0c} ins(%250, %252 : tensor<128x128xbf16>, tensor<128x128xbf16>) outs(%254 : tensor<128x128xf32>) -> tensor<128x128xf32>
          %reduced_45 = linalg.reduce ins(%249 : tensor<128x128xf32>) outs(%5 : tensor<128xf32>) dimensions = [1]  {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"}
            (%in: f32, %init: f32) {
              %262 = arith.addf %in, %init : f32
              linalg.yield %262 : f32
            }
          %256 = arith.subf %arg36, %247 {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %257 = math.exp %256 {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %258 = arith.mulf %arg37, %257 {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %259 = arith.addf %258, %reduced_45 {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128xf32>
          %broadcasted_46 = linalg.broadcast ins(%257 : tensor<128xf32>) outs(%6 : tensor<128x128xf32>) dimensions = [1]  {ssbuffer.block_id = 26 : i32, ssbuffer.core_type = "VECTOR"}
          %260 = arith.mulf %arg38, %broadcasted_46 {ssbuffer.block_id = 27 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          %261 = arith.addf %255, %260 {ssbuffer.add_from_matmul, ssbuffer.block_id = 27 : i32, ssbuffer.core_type = "VECTOR"} : tensor<128x128xf32>
          scf.yield {ssbuffer.core_type = "VECTOR, VECTOR, VECTOR"} %247, %259, %261 : tensor<128xf32>, tensor<128xf32>, tensor<128x128xf32>
        } {ssbuffer.core_type = "VECTOR, VECTOR, VECTOR"}
